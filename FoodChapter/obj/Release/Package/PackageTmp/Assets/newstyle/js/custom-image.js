    ...
    var mainApp = {
        ...
        main_fun:function() {
            ...
            $(function () {
                $.vegas('slideshow', {
                    backgrounds: [
                      { src: '../Assests/newstyle/img/4.jpg', fade: 1000, delay: 9000 }, //CHANGE THESE IMAGES WITH YOUR ORIGINAL IMAGES
                    ...
                    src: '../Assests/newstyle/plugins/vegas/overlays/15.png' // THERE ARE TOTAL 01 TO 15 .png IMAGES AT THE PATH GIVEN, WHICH YOU CAN USE HERE
                });
