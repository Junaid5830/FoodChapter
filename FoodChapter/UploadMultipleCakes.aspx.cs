...
{
    public partial class UploadMultipleCakes : System.Web.UI.Page
    {
        ...
        {
            string cakename = vendorId + "_Cake_" + DateTime.Now.Date.ToString("dd-MM-yyyy") +"_"+ DateTime.Now.Hour + DateTime.Now.Minute + DateTime.Now.Second;
            return cakename;
        }
    }
}