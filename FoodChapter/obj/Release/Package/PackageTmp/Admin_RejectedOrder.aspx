<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="Admin_RejectedOrder.aspx.cs" Inherits="FoodChapter.Admin_RejectedOrder" %>
   ...
   <script>
        ...
        $(document).ready(function () {
            window.onload = function () {
                $.ajax({
                  url: '/api/Order/GetAdminRejectedOrderReport',
                    type: 'Get',
                    contentType: 'application/json',
                    dataType: 'json',
                    statusCode: {
