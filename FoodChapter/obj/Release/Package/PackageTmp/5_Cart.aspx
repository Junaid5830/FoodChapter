<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="5_Cart.aspx.cs" Inherits="FoodChapter._5_Cart" %>
...
//            var updateTotal = parseInt(document.getElementById("tbox" + currentIndex).value) * parseInt($('#cartTable tr:eq(' + newIndex + ') td:eq(3)').text());
        ...
        function calculateTotal(total) {
          ...
          //commented by me as they are not getting called
        ...
        //            window.location = "1_home.aspx";
        //        }
        //        else
        //            //window.location = 'ConfirmOrder.aspx';
        //            window.location = '10_checkout.aspx';
        //    }
        //}
...
<div class="cart_pg_wrap">
        ...
        <div class="update_cart col-md-6">
			...
			<div class="proceed_btn_wrap col-md-12">
				<div>
					<a href="10_checkout.aspx"><button class="proceed_btn">PROCEED TO CHECKOUT</button></a>
				</div>
			</div>
