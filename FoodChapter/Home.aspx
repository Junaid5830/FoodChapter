<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="FoodChapter.Home" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="content">
                        ...
                        <div class="my_content_wrap">
                            ...
                            <a href="SellerRegister.aspx">
                                <div class="cat_img1 col-md-4 col-sm-4">
                                    ...
                                    <img src="Frontend/images/caterers_tile_bg.jpg" style="width: 100%; border-radius: 7px;">
                                </div>
                            </a>
                        </div>
                    </div>
                    <div class="my-content-section col-md-12 col-sm-12">
                        ...
                        <div class="my_content_products col-md-12 col-sm-12">
                            ...
                            <div class="hm_view_more col-md-12" style="text-align: center; margin-top: 50px;">
                                <a href="Gallery.aspx">
  ...
  <div class="container">
    ...
    //Home filter (remove and append active class)
    ...
    function showTopSellers() {
      $.ajax({
        ...
        function showFoods() {
            length = $('#filter-masonry-foods').find('.my_gallery_row ').length;
            document.getElementsByClassName("gallery")[0].style.display = length < 8 ? 'none' : 'inline-block';
        ...
        function showSearch() {
            document.getElementsByClassName("gallery")[0].style.display = 'inline-block';
            var x = document.getElementById("filter-masonry");
            x.style.display = 'block';
            var x = document.getElementById("filter-masonry-cakes");
            x.style.display = 'none';
        ...
        function showCakes() {
            var length = $('#filter-masonry-cakes').find('.my_gallery_row ').length;
            document.getElementsByClassName("gallery")[0].style.display = length < 8 ? 'none' : 'inline-block';
            var x = document.getElementById("filter-masonry");
            x.style.display = 'none';
            var x = document.getElementById("filter-masonry-cakes");
        ...
        function showDesserts() {
            var length = $('#filter-masonry-desserts').find('.my_gallery_row ').length;
            document.getElementsByClassName("gallery")[0].style.display = length < 8 ? 'none' : 'inline-block';
            var x = document.getElementById("filter-masonry");
            x.style.display = 'none';
            var x = document.getElementById("filter-masonry-cakes");
        ...
        function showFrozen() {
            length = $('#filter-masonry-frozen').find('.my_gallery_row ').length;
            document.getElementsByClassName("gallery")[0].style.display = length < 8 ? 'none' : 'inline-block';
            var x = document.getElementById("filter-masonry");
            x.style.display = 'none';
      ...
      statusCode: {
        200: function (data) {
          ...
          for (var i = 0; i < json1.PRODUCTS.length; i++) {
            ...
            //alert(url);
            var url = json1.PRODUCTS[i].PRODUCT_PHOTO;
            $(".filter-masonry-foods").append('<div class="my_gallery_row col-lg-3 col-md-4 col-sm-6"><a class="hhover" href="javascript:void(0);" onclick="viewDetail(' + json1.PRODUCTS[i].PRODUCT_ID + ')"><img class="my_home_img img-responsive" id="foodsImage' + json1.PRODUCTS[i].PRODUCT_ID + '" src=""' + url + '"></a><h3>' + json1.PRODUCTS[i].NAME + '</h3><span>' + 'Rs ' + json1.PRODUCTS[i].PRICE + '</span><div class=" hm_gallery_overlay"><a class="sm-btn1" href="javascript:void(0);"><a class="hhover2" href="javascript:void(0);" onclick="viewDetail(' + json1.PRODUCTS[i].PRODUCT_ID + ')"></a>   <span class="fa fa-star gallerystar checked"></span><span class="fa fa-star gallerystar checked"></span><span class="fa fa-star gallerystar checked"></span><span class="fa fa-star gallerystar "></span><span class="fa fa-star gallerystar "></span></a></div></div>');
      ...
      statusCode: {
        200: function (data) {
          ...
          for (var i = 0; i < json1.CAKES.length; i++) {
            ...
            var url = json1.CAKES[i].CAKE_PHOTO;
              //alert(url);
              $("#filter-masonry-cakes").append('<div class="my_gallery_row col-lg-3 col-md-4 col-sm-6"><a href="javascript:void(0);" onclick="viewDetail(' + json1.CAKES[i].CAKE_ID + ')"><img class="my_home_img img-responsive" id="cakesImage' + json1.CAKES[i].CAKE_ID + '" src="" ' + url + '" ></a><h3>' + json1.CAKES[i].NAME + '</h3><span>' + 'Rs ' + json1.CAKES[i].PRICE + '</span><div class=" hm_gallery_overlay"> <a class="hhover2" href="javascript:void(0);" onclick="viewDetail(' + json1.CAKES[i].CAKE_ID + ')"></a>  <span class="fa fa-star gallerystar checked"></span><span class="fa fa-star gallerystar checked"></span><span class="fa fa-star gallerystar checked"></span><span class="fa fa-star gallerystar "></span><span class="fa fa-star gallerystar "></span></a></div></div>');
      ...
      statusCode: {
        200: function (data) {
          ...
          for (var i = 0; i < json1.PRODUCTS.length; i++) {
            ...
            //alert(url);
            var url = json1.PRODUCTS[i].PRODUCT_PHOTO;
            $("#filter-masonry-frozen").append('<div class="my_gallery_row col-lg-3 col-md-4 col-sm-6"><a class="sm-btn1" href="javascript:void(0);"><a class="hhover" href="javascript:void(0);" onclick="viewDetail(' + json1.PRODUCTS[i].PRODUCT_ID + ')"><img class="my_home_img img-responsive"  id="frozenImage' + json1.PRODUCTS[i].PRODUCT_ID + '" src=""' + url + '"></a><h3>' + json1.PRODUCTS[i].NAME + '</h3><span>' + 'Rs ' + json1.PRODUCTS[i].PRICE + '</span><div class=" hm_gallery_overlay"> <a class="hhover2" href="javascript:void(0);" onclick="viewDetail(' + json1.PRODUCTS[i].PRODUCT_ID + ')"></a>   <span class="fa fa-star gallerystar checked"></span><span class="fa fa-star gallerystar checked"></span><span class="fa fa-star gallerystar checked"></span><span class="fa fa-star gallerystar "></span><span class="fa fa-star gallerystar "></span></a></div></div>');
    ...
    $.ajax({
      ...
      statusCode: {
        200: function (data) {
          ...
          for (var i = 0; i < json1.PRODUCTS.length; i++) {
            var url = json1.PRODUCTS[i].PRODUCT_PHOTO;
            $("#filter-masonry-desserts").append('<div class="my_gallery_row col-lg-3 col-md-4 col-sm-6"><a class="" href="javascript:void(0);" onclick="viewDetail(' + json1.PRODUCTS[i].PRODUCT_ID + ')"><img class="my_home_img img-responsive" id="dessertImage' + json1.PRODUCTS[i].PRODUCT_ID + '" src=""' + url + '"></a><h3>' + json1.PRODUCTS[i].NAME + '</h3><span>' + 'Rs ' + json1.PRODUCTS[i].PRICE + '</span><div class=" hm_gallery_overlay"> <a class="sm-btn1" href="javascript:void(0);"><a class="hhover2" href="javascript:void(0);" onclick="viewDetail(' + json1.PRODUCTS[i].PRODUCT_ID + ')"></a>   <span class="fa fa-star gallerystar checked"></span><span class="fa fa-star gallerystar checked"></span><span class="fa fa-star gallerystar checked"></span><span class="fa fa-star gallerystar "></span><span class="fa fa-star gallerystar "></span></a></div></div>');
