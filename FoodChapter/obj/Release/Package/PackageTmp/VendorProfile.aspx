<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Vendor.Master" AutoEventWireup="true" CodeBehind="VendorProfile.aspx.cs" Inherits="FoodChapter.WebPages.VendorProfile" %>
                ...
                200: function (data) {
                  ...
                  console.log(data);
                    for (var i = 0; i < json1.VENDOR.length; i++) {
                        ...
                        var url = json1.VENDOR[i].CNIC_IMAGE;

                        $("#uploadCNIC").attr("src", url).width(220).height(220);
            ...
            $.ajax({
                ...
                statusCode: {
                    200: function () {
                        ...
                        document.getElementById("lblMessage").style.color = '#f68c93';
                        //location.reload();
          ...
          <div class="col-md-12">
            <div class="col-md-6 mbottom ">
                ...
                <div class="col-sm-10 rtp">
                    ...
                    <img id="vendorImage" src="" alt="Please Provide 300X300 Photo or above" />
                </div>
            </div>
           <div class="col-md-6 mbottom ">
                ...
                <div class="col-sm-10 rtp">
                    ...
                    <img id="uploadCNIC" src="" alt="Please Provide 300X300 Photo or above" />
                </div>
            </div>
            </div>
        </div>
