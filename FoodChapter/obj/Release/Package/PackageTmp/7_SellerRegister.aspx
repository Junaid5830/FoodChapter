<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="7_SellerRegister.aspx.cs" Inherits="FoodChapter._7_SellerRegister" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        var REDIRECT = 'http://foodchapter.pk/2_gallery.aspx';
        ...
        <div class="container">
            ...
            <div class="my_container_section">
                <div class="login_tabs">
                    <a href="6_Login.aspx">LOGIN</a>
                    <a class="active" href="7_SellerRegister.aspx">SELLER REGISTRATION</a>
                    <a href="FoodiesRegister.aspx">FOODIES REGISTRATION</a>
                </div>
                <div class="sr_container_wrapper col-sm-12">

                    <div class="sr_left col-md-7 col-sm-12">
                        <div class="wraplogin_form">
                            <form role="form" class="form-horizontal" id="formSaveVendor" action="#">
                                <div class="login_form_wrap" data-validate="Name is required">
                                    <input class="login_input" type="text" id="FirstName" placeholder="FIRST NAME" required="FName is required">
                                    <span class="login_placeholder" data-placeholder="FIRST NAME"></span>
                                </div>
                                <div class="login_form_wrap" data-validate="Name is required">
                                    <input class="login_input" type="text" id="LastName" placeholder="LAST NAME" required="LName is required">
                                    <span class="login_placeholder" data-placeholder="LAST NAME"></span>
                                </div>
                                <div class="login_form_wrap" data-validate="Email is required">
                                    <input class="login_input" type="email" id="txtVendorEmail" placeholder="EMAIL" required="Email is required">
                                    <span class="login_placeholder" data-placeholder="EMAIL"></span>
                                </div>

                                <div class="login_form_wrap" data-validate="Mobile is required">
                                    <input class="login_input" type="number" id="txtVendorMobile1" placeholder="MOBILE" required="Mobile is required">
                                    <span class="login_placeholder" data-placeholder="MOBILE"></span>
                                </div>

                                <div class="login_form_wrap" data-validate="CNIC is required">
                                    <input class="login_input" type="number" id="CNIC" placeholder="CNIC" required="CNIC is required">
                                    <span class="login_placeholder" data-placeholder="CNIC"></span>
                                </div>

                                <div class="login_form_wrap" data-validate="Password is required">
                                    <input class="login_input" type="password" id="txtVendorPassword" placeholder="PASSWORD" required="password is required">
                                    <span class="login_placeholder" data-placeholder="PASSWORD"></span>
                                </div>
                                <div class="login_form_wrap" data-validate="Entity is required">
                                    <input class="login_input" id="txtVendorEntity" type="text" placeholder="Business Entity Name" required="entity is required">
                                ...
                                <div class="login_form_wrap" data-validate="Address is required">
                                    <textarea class="login_placeholder login_input subject" id="address" placeholder="ADDRESS" required="address is required" style="height: 100px"></textarea>
                                </div>
                                <div class="login_form_wrap" data-validate="Password is required">
                                    <textarea class="login_placeholder login_input subject" id="subject" placeholder="BIOGRAPHY" required="bio is required" style="height: 100px"></textarea>
                                </div>
                                ...
                                <div class="seller_reg_pic">
                                    <div class="circle-img col-md-offset-3">
                                        <img id="vendorImage" src="Frontend/images/home_seller1.png">
                                    </div>
                                    <input class="img-show" type='file' required="image is required" id="imgInp" onchange="readURL(this);" />
                                ...
                                <div class="code_verify">
                                    ...
                                    <div class="verify_wrap1">
                                        <textarea class="verify1" name="txtInput" id="txtInput" required="code is required" style="height: 60px; width: 200px;"></textarea>
                                    </div>
                                </div>
            ...
            <div class="modal-dialog modal-lg" style="width: 400px;">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 id="showModel" class="modal-title" style="text-align: center; color: #780103; font-size: 35px;"></h4>
                    </div>
