<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="SelectCake.aspx.cs" Inherits="FoodChapter.SelectCake" %>
                ...
                statusCode: {
                    200: function (data) {
                        ...
                        if (json1.CAKES.length == 0 && cakeShowCount ==1) {
                            //show modal and redirect to vendorprofile.aspx
                        }
                        else {
                            //if (cakeShowCount == 0) {
