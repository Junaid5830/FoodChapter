<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="2_gallery.aspx.cs" Inherits="FoodChapter._2_gallery" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        var foodShowCount = 1,allShowCount = 1,frozenShowCount=1,dessertShowCount =1,cakeShowCount =1;
                    ...
                    200: function (data) {
                        ...
                        for (var i = 0; i < json1.PRODUCTS.length; i++) {
                            ...
                            if (json1.PRODUCTS[i].CATEGORY_ID == 3) {
                                ...
                                $("#filter-masonry").append('<div class="my_gallery_row rgallery col-lg-4 col-md-4 col-sm-6"><img id="productImage' + json1.PRODUCTS[i].PRODUCT_ID + '" src=""' + url + '" class="my_gallery img-responsive"><h3>' + json1.PRODUCTS[i].NAME + '</h3><span>' + 'Rs ' + json1.PRODUCTS[i].PRICE + '</span><div class="gallery_overlay"><a class="sm-btn1" href="javascript:void(0);"><a class="ghover" href="javascript:void(0);" onclick="addToCart(' + json1.PRODUCTS[i].PRODUCT_ID + ')"></a><a class="ghover2" href="javascript:void(0);" onclick="viewDetail(' + json1.PRODUCTS[i].PRODUCT_ID + ')"></a>   <span class="fa fa-star gallerystar checked"></span><span class="fa fa-star gallerystar checked"></span><span class="fa fa-star gallerystar checked"></span><span class="fa fa-star gallerystar "></span><span class="fa fa-star gallerystar "></span></a></div></div>');
                                ...
                                $("#filter-masonry").append('<div class="my_gallery_row rgallery col-lg-4 col-md-4 col-sm-6"><img id="dessertImage' + json1.PRODUCTS[i].PRODUCT_ID + '" src=""' + url + '" class="my_gallery img-responsive"><h3>' + json1.PRODUCTS[i].NAME + '</h3><span>' + 'Rs ' + json1.PRODUCTS[i].PRICE + '</span><div class="gallery_overlay"><a class="sm-btn1" href="javascript:void(0);"><a class="ghover" href="javascript:void(0);" onclick="addToCart(' + json1.PRODUCTS[i].PRODUCT_ID + ')"></a><a class="ghover2" href="javascript:void(0);" onclick="viewDetail(' + json1.PRODUCTS[i].PRODUCT_ID + ')"></a>   <span class="fa fa-star gallerystar checked"></span><span class="fa fa-star gallerystar checked"></span><span class="fa fa-star gallerystar checked"></span><span class="fa fa-star gallerystar "></span><span class="fa fa-star gallerystar "></span></a></div></div>');
                                ...
                                $("#filter-masonry").append('<div class="my_gallery_row rgallery col-lg-4 col-md-4 col-sm-6"><img id="frozenImage' + json1.PRODUCTS[i].PRODUCT_ID + '" src=""' + url + '" class="my_gallery img-responsive"><h3>' + json1.PRODUCTS[i].NAME + '</h3><span>' + 'Rs ' + json1.PRODUCTS[i].PRICE + '</span><div class="gallery_overlay"><a class="sm-btn1" href="javascript:void(0);"><a class="ghover" href="javascript:void(0);" onclick="addToCart(' + json1.PRODUCTS[i].PRODUCT_ID + ')"></a><a class="ghover2" href="javascript:void(0);" onclick="viewDetail(' + json1.PRODUCTS[i].PRODUCT_ID + ')"></a>   <span class="fa fa-star gallerystar checked"></span><span class="fa fa-star gallerystar checked"></span><span class="fa fa-star gallerystar checked"></span><span class="fa fa-star gallerystar "></span><span class="fa fa-star gallerystar "></span></a></div></div>');
                            ...
                            statusCode: {
                                ...
                                200: function (data) {
                                    ...
                                    for (var i = 0; i < json1.CAKES.length; i++) {
                                        ...
                                        $("#filter-masonry").append('<div class="my_gallery_row col-lg-4 col-md-4 col-sm-6"><img id="cakesImage' + json1.CAKES[i].CAKE_ID + '"src=""' + url + '" class="my_gallery"> <h3>' + json1.CAKES[i].NAME + '</h3><span>' + 'Rs ' + json1.CAKES[i].PRICE + '</span><div class="gallery_overlay"><a class="sm-btn1" href="javascript:void(0);"><a class="ghover" href="javascript:void(0);" onclick="addCakeToCart(' + json1.CAKES[i].CAKE_ID + ')"></a><a class="ghover2" href="javascript:void(0);" onclick="viewDetail(' + json1.CAKES[i].CAKE_ID + ')"></a>   <span class="fa fa-star gallerystar checked"></span><span class="fa fa-star gallerystar checked"></span><span class="fa fa-star gallerystar checked"></span><span class="fa fa-star gallerystar "></span><span class="fa fa-star gallerystar "></span></a></div></div>');
                ...
                statusCode: {
                    ...
                    200: function (data) {
                        ...
                        for (var i = 0; i < json1.PRODUCTS.length; i++) {
                            ...
                            $("#filter-masonry-foods").append('<div class="my_gallery_row rgallery col-lg-4 col-md-4 col-sm-6"><img id="foodsImage' + json1.PRODUCTS[i].PRODUCT_ID + '" src=""' + url + '" class="my_gallery img-responsive"><h3>' + json1.PRODUCTS[i].NAME + '</h3><span>' + 'Rs ' + json1.PRODUCTS[i].PRICE + '</span><div class="gallery_overlay"><a class="sm-btn1" href="javascript:void(0);"><a class="ghover" href="javascript:void(0);" onclick="addToCart(' + json1.PRODUCTS[i].PRODUCT_ID + ')"></a><a class="ghover2" href="javascript:void(0);" onclick="viewDetail(' + json1.PRODUCTS[i].PRODUCT_ID + ')"></a>   <span class="fa fa-star gallerystar checked"></span><span class="fa fa-star gallerystar checked"></span><span class="fa fa-star gallerystar checked"></span><span class="fa fa-star gallerystar "></span><span class="fa fa-star gallerystar "></span></a></div></div>');
                ...
                statusCode: {
                    ...
                    200: function (data) {
                        ...
                        for (var i = 0; i < json1.PRODUCTS.length; i++) {
                            ...
                            $("#filter-masonry-frozen").append('<div class="my_gallery_row rgallery col-lg-4 col-md-4 col-sm-6"><img id="frozenImage' + json1.PRODUCTS[i].PRODUCT_ID + '" src=""' + url + '" class="my_gallery img-responsive"><h3>' + json1.PRODUCTS[i].NAME + '</h3><span>' + 'Rs ' + json1.PRODUCTS[i].PRICE + '</span><div class="gallery_overlay"><a class="sm-btn1" href="javascript:void(0);"><a class="ghover" href="javascript:void(0);" onclick="addToCart(' + json1.PRODUCTS[i].PRODUCT_ID + ')"></a><a class="ghover2" href="javascript:void(0);" onclick="viewDetail(' + json1.PRODUCTS[i].PRODUCT_ID + ')"></a>   <span class="fa fa-star gallerystar checked"></span><span class="fa fa-star gallerystar checked"></span><span class="fa fa-star gallerystar checked"></span><span class="fa fa-star gallerystar "></span><span class="fa fa-star gallerystar "></span></a></div></div>');
                ...
                statusCode: {
                    ...
                    200: function (data) {
                        ...
                        for (var i = 0; i < json1.PRODUCTS.length; i++) {
                            ...
                            $("#filter-masonry-desserts").append('<div class="my_gallery_row rgallery col-lg-4 col-md-4 col-sm-6"><img id="dessertImage' + json1.PRODUCTS[i].PRODUCT_ID + '" src=""' + url + '" class="my_gallery img-responsive"><h3>' + json1.PRODUCTS[i].NAME + '</h3><span>' + 'Rs ' + json1.PRODUCTS[i].PRICE + '</span><div class="gallery_overlay"><a class="sm-btn1" href="javascript:void(0);"><a class="ghover" href="javascript:void(0);" onclick="addToCart(' + json1.PRODUCTS[i].PRODUCT_ID + ')"></a><a class="ghover2" href="javascript:void(0);" onclick="viewDetail(' + json1.PRODUCTS[i].PRODUCT_ID + ')"></a>   <span class="fa fa-star gallerystar checked"></span><span class="fa fa-star gallerystar checked"></span><span class="fa fa-star gallerystar checked"></span><span class="fa fa-star gallerystar "></span><span class="fa fa-star gallerystar "></span></a></div></div>');
            ...
            <div class="gallery_container_wrapper">
                <div class="my_sidebar col-md-3 col-sm-12">
                    <div class="sidebar_wrapper_gallery col-md-12">
                        ...
                        <label>
                            <input type="checkbox" class="mint filterData1" name="chkAll" id="chkAll" /><span>All</span></label><br />
                        <%--<label><input type="radio" class="mint filterData0" name="chkDelievery" id="chkDelievery" /><span>Delievery</span></label><br />--%>
                        <label>
                            <input type="checkbox" class="mint filterData2" id="chkFoods" /><span>Foods</span></></label><br />
                        <label>
                        ...
                        <label>
                            <input type="checkbox" class="mint filterData5" id="chkFrozen" /><span>Frozen Foods</span></label><br />
            ...
            <div class="modal-dialog modal-lg" style="width:400px;">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" style="text-align: center; color:#780103; font-size:35px;">Welcome to
							Food Chapter!
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="col-md-9 col-md-offset-2" style="margin-bottom:10px;">
									...
									<a href="http://foodchapter.pk/5_cart.aspx"><button class="rmodal_btn rm_1" style="width: 45%;">Go to Cart</button></a>
									<a href="javascript:void(0);"><button class="rmodal_btn" style="float: right;" id="btnHungry">Still Hungry!</button></a>
                                </div>
                            </div>
