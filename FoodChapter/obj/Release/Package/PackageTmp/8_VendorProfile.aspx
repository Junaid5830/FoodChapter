<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="8_VendorProfile.aspx.cs" Inherits="FoodChapter._8_VendorProfile" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            if (urlParams.has("id")) {
                $.ajax({
                    url: '/api/Vendors/GetVendorProfileByUniqueId',
                    type: 'Get',
                    contentType: 'application/json',
                    dataType: 'json',
                    data: { 'uniqueId': urlParams.get("id") },
                    statusCode: {
                        200: function (data) {
            ...
            $.ajax({
              ...
              statusCode: {
                200: function (data) {
                  ...
                  if (json2.VENDOR_REVIEW[0].ORDER_COUNT != 0) {
                    var vendorReview = {
                      "VENDOR_ID": vendorId,
                      "CUSTOMER_ID": userId,
                      "RATING": userRating,
        ...
        //    var cat = document.getElementById('textReview').value;
        //    var cake = {
        //        "REVIEW": cat,
        //        'VENDOR_ID': vendorId,
        //        'USER_ID':userId
                ...
                statusCode: {
                    200: function (data) {
                        ...
                        for (var i = 0; i < json1.CAKES.length; i++) {
                            debugger;
                            var url = json1.CAKES[i].CAKE_PHOTO;
                            $("#filter-masonry-cakes").append('<div class="my_gallery_row col-lg-4 col-md-4 col-sm-6"><img class="my_gallery img-responsive" id="cakesImage' + json1.CAKES[i].CAKE_ID + '" src="" ' + url + '" ><h3>' + json1.CAKES[i].NAME + '</h3><span>' + 'Rs ' + json1.CAKES[i].PRICE + '</span><div class=" gallery_overlay"><a class="sm-btn1" href="javascript:void(0);"><a class="phover" href="javascript:void(0);" onclick="addToCart(' + json1.CAKES[i].CAKE_ID + ')"></a><a class="phover2" href="javascript:void(0);" onclick="viewDetail(' + json1.CAKES[i].CAKE_ID + ')"></a>   <span class="fa fa-star gallerystar checked"></span><span class="fa fa-star gallerystar checked"></span><span class="fa fa-star gallerystar checked"></span><span class="fa fa-star gallerystar "></span><span class="fa fa-star gallerystar "></span></a></div></div>');
                            $("#cakesImage" + json1.CAKES[i].CAKE_ID).attr("src", url);
                ...
                statusCode: {
                    200: function (data) {
                        ...
                        for (var i = 0; i < json1.PRODUCTS.length; i++) {
                            ...
                            //alert(url);
                            var url = json1.PRODUCTS[i].PRODUCT_PHOTO;
                            $("#filter-masonry-desserts").append('<div class="my_gallery_row col-lg-4 col-md-4 col-sm-6"><img class="my_gallery img-responsive" id="dessertImage' + json1.PRODUCTS[i].PRODUCT_ID + '" src=""' + url + '"class="my_gallery"><h3>' + json1.PRODUCTS[i].NAME + '</h3><span>' + 'Rs ' + json1.PRODUCTS[i].PRICE + '</span><div class="gallery_overlay"> <a class="sm-btn1" href="javascript:void(0);"><a class="phover" href="javascript:void(0);" onclick="addToCart(' + json1.PRODUCTS[i].PRODUCT_ID + ')"></a><a class="phover2" href="javascript:void(0);" onclick="viewDetail(' + json1.PRODUCTS[i].PRODUCT_ID + ')"></a>   <span class="fa fa-star gallerystar checked"></span><span class="fa fa-star gallerystar checked"></span><span class="fa fa-star gallerystar checked"></span><span class="fa fa-star gallerystar "></span><span class="fa fa-star gallerystar "></span></a></div></div>');
                ...
                statusCode: {
                    200: function (data) {
                        ...
                        for (var i = 0; i < json1.PRODUCTS.length; i++) {
                            ...
                            var url = json1.PRODUCTS[i].PRODUCT_PHOTO;
                            $(".filter-masonry-foods").append('<div class="my_gallery_row col-lg-4 col-md-4 col-sm-6"><img class="my_gallery img-responsive" id="foodsImage' + json1.PRODUCTS[i].PRODUCT_ID + '" src=""' + url + '"class="my_gallery"><h3>' + json1.PRODUCTS[i].NAME + '</h3><span>' + 'Rs ' + json1.PRODUCTS[i].PRICE + '</span><div class="gallery_overlay"> <a class="sm-btn1" href="javascript:void(0);"><a class="phover" href="javascript:void(0);" onclick="addToCart(' + json1.PRODUCTS[i].PRODUCT_ID + ')"></a><a class="phover2" href="javascript:void(0);" onclick="viewDetail(' + json1.PRODUCTS[i].PRODUCT_ID + ')"></a>   <span class="fa fa-star gallerystar checked"></span><span class="fa fa-star gallerystar checked"></span><span class="fa fa-star gallerystar checked"></span><span class="fa fa-star gallerystar "></span><span class="fa fa-star gallerystar "></span></a></div></div>');
            ...
            $.ajax({
                ...
                statusCode: {
                    200: function (data) {
                        ...
                        for (var i = 0; i < json1.PRODUCTS.length; i++) {
                            var url = json1.PRODUCTS[i].PRODUCT_PHOTO;
                            $(".filter-masonry-frozen").append('<div class="my_gallery_row col-lg-4 col-md-4 col-sm-6"><img class="my_gallery img-responsive" id="foodsImage' + json1.PRODUCTS[i].PRODUCT_ID + '" src=""' + url + '"class="my_gallery"><h3>' + json1.PRODUCTS[i].NAME + '</h3><span>' + 'Rs ' + json1.PRODUCTS[i].PRICE + '</span><div class=" gallery_overlay"> <a class="sm-btn1" href="javascript:void(0);"><a class="phover" href="javascript:void(0);" onclick="addToCart(' + json1.PRODUCTS[i].PRODUCT_ID + ')"></a><a class="phover2" href="javascript:void(0);" onclick="viewDetail(' + json1.PRODUCTS[i].PRODUCT_ID + ')"></a>   <span class="fa fa-star gallerystar checked"></span><span class="fa fa-star gallerystar checked"></span><span class="fa fa-star gallerystar checked"></span><span class="fa fa-star gallerystar "></span><span class="fa fa-star gallerystar "></span></a></div></div>');
                            $("#frozenImage" + json1.PRODUCTS[i].PRODUCT_ID).attr("src", url);
                        }
        ...
        <div class="p_container_wrap col-md-12">
            <div class="profile_sect1">
                <div class="pg_wrapper col-md-3">
                    <img id="vendorProfileImage" src="Frontend/images/home_seller2.png" />
                </div>
...
<div id="filter-masonry" class="products-grid-list">
              ...
              <div id="filter-masonry-frozen" class="products-grid-list-frozen">
                    ...
                    <div class="profile_sect4 col-md-12">
                        ...
                        <div class="profile_review_body col-md-12" id="addReview" style="display: none">
                            <div class="row col-md-12">
                                <div class="col-md-12">
                                    <textarea class="profile_review_body form-control " style="height: 200px; border: none !important; border-bottom: 1px dashed #ccc !important; height: 34px !important; box-shadow: none;"
