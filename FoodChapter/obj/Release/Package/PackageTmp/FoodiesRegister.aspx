        ...
        <div class="container">
            ...
            <div class="my_container_section">
                <div class="login_tabs">
                    ...
                    <a href="7_SellerRegister.aspx">SELLER REGISTRATION</a>
                ...
                <div class="sr_container_wrapper col-sm-12">
                        ...
                        <div class="wraplogin_form">
                            <form role="form" class="form-horizontal" id="formSaveUser" action="#">
                                ...
                                <div class="login_form_wrap" data-validate="Mobile is required">
                                    <input class="login_input" type="text" id="txtUserMobile1" placeholder="MOBILE" required="Mobile is required">
                    ...
                    <div class="contact_right col-md-4 col-sm-12">
                        <%--<div class="login_right">
                            <button class="login"><a href="javascript:void(0);" onclick="document.getElementById('fbSignIN').style.display = 'block';">
                                <img src="Frontend/images/login_03.png" style="width: 300px;"></a></button>
                            ...
                            <button class="login"><a href="javascript:void(0);" onclick="googleLogin()">
                                <img src="Frontend/images/login_06.png" style="width: 300px;"></a></button>
                        </div>--%>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-dialog modal-lg" style="width: 400px;">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" style="text-align: center; color: #780103; font-size: 35px;">Mobile and Email Already Exist!
