<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="Admin_CompleteOrder.aspx.cs" Inherits="FoodChapter.Admin_CompleteOrder" %>
   ...
   <script>
        ...
        $(document).ready(function () {
            window.onload = function () {
                $.ajax({
                  url: '/api/Order/GetAdminCompletedOrderReport',
                    type: 'Get',
                    contentType: 'application/json',
                    dataType: 'json',
                    statusCode: {
