<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Vendor.Master" AutoEventWireup="true" CodeBehind="RejectedOrder.aspx.cs" Inherits="FoodChapter.RejectedOrder" %>
   ...
   <script>
        ...
        $(document).ready(function () {
            window.onload = function () {
                ...
                $.ajax({
                  url: '/api/Order/GetRejectedOrderReport',
                    type: 'Get',
                    contentType: 'application/json',
                    dataType: 'json',
                        ...
                        200: function (data) {
                            ...
                            for (var i = 0; i < json1.ORDER_DETAILS.length; i++) {
                                $("#pendingorder").append('<tr class="even pointer"><td class=" "><a href="#">' + json1.ORDER_DETAILS[i].ORDER_ID + '</a></td>'
                                    ...
                                    + '<td class=" ">' + json1.ORDER_DETAILS[i].GREETINGS + '</td> <td class=" ">Rejected</td>'
