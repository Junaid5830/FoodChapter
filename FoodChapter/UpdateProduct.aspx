                ...
                function funUpdateProduct() {
                    ...
                    $.ajax({
                        ...
                        statusCode: {
                            200: function (data) {
                                ...
                                $.ajax({
                                    ...
                                    statusCode: {
                                        ...
                                        500: function () {
                                            $('#msgModal').modal('show');
                                            document.getElementById("lblMessage").innerHTML = "Tags not saved.";
                                            document.getElementById("lblMessage").style.color = 'red';
                                        }
                                    },
                                    jsonp: 'jsonp'
                            ...
                            500: function () {
                                //$('#msgModal').modal('show');loadSubCategories                                document.getElementById("lblMessage").innerHTML = "Product not saved.";
                                document.getElementById("lblMessage").style.color = 'red';
                            }
                        },
                        jsonp: 'jsonp'
                ...
                <form id="formSaveProduct" action="#">
                    <div class="col-md-12">
                       ...
                       <div class="row form-group col-md-12">
                        ...
                        <div class="row form-group col-md-6">
                            <label class="control-label col-md-4 col-sm-3 col-xs-12 rlabel rnp" for="subDescription">Time Required<span style="font-size:13px; margin:10px;">(hours)</span></label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="row form-group col-md-6" id="serves">
                            <label class="control-label col-md-4 col-sm-3 col-xs-12 rlabel" for="subDescription">Serves<span style="font-size:13px; margin:10px;">(Persons)</span></label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="row form-group col-md-6">
                            <label class="control-label col-md-4 col-sm-3 col-xs-12 rlabel" for="subDescription">Price<span style="font-size:13px; margin:10px;">(PKR)</span></label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
