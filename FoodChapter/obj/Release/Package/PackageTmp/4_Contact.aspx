<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="4_Contact.aspx.cs" Inherits="FoodChapter._4_Contact" %>
		...
		<div class="contact_container_wrapper col-sm-12">
			<div class="contact_left col-md-6 col-sm-12">
				...
				<div class="text_contact2 col-md-6">
					...
					<p class="p_text_contact"> +92 345 3177413</p>
				</div>
