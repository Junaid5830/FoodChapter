<%@ Page Title="Pending Order" Language="C#" MasterPageFile="~/MasterPages/Vendor.Master" AutoEventWireup="true" CodeBehind="pendingorder.aspx.cs" Inherits="FoodChapter.WebPages.pendingorder" %>
    ...
    <script>
        ...
        $(document).ready(function () {
            window.onload = function () {
                ...
                $.ajax({
                    url: '/api/Order/GetPreviousOrderReport',
                    type: 'Get',
                    contentType: 'application/json',
                    dataType: 'json',
