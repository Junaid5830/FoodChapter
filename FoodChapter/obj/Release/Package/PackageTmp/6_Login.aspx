<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="6_Login.aspx.cs" Inherits="FoodChapter._6_Login" %>
            ...
            AccountKit.init(
              {
                  ...
                  Redirect: "https://foodchapter.pk/2_gallery.aspx"
...
<div class="container ">
	...
	<div class="rloginwrap col-md-12">
		<div class="login_tabs col-md-12">
			<a style="font-size:35px" class="active" href="6_Login.aspx">LOGIN</a>
		</div>
