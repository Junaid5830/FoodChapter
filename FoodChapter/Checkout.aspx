<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="Checkout.aspx.cs" Inherits="FoodChapter.Checkout" %>
        ...
        function sendOrderEmail(OrderId)
        {
            ...
            $.ajax({
                ...
                statusCode: {
                    ...
                    500: function () {
                      $('#myregistration').modal('show');
                      document.getElementById('divModel').innerHTML = "Thank You! Your Order is saved Successfully";
            ...
            <div class="checkout_left col-md-6 col-sm-12">
                <div class="wrapcheckout_form">
                    ...
                    <div class="checkout_form_wrap col-md-12" data-validate="Mobile is required">
                        <input class="checkout_input" type="text" name="txtMob" id="txtMob" onkeypress="phoneno()" maxlength="11" placeholder="MOBILE NUMBER" />
